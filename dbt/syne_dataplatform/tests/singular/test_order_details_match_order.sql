...
SELECT
    o.*,
    od.*
FROM {# {{ ref('stg_thelook_ecommerce__orders') }} AS o #}
 {{ target.schema}}.stg_ecommerce__orders as o
-- If you want to run test but does not want this test to reference using stg_thelook_ecommerce__orders
